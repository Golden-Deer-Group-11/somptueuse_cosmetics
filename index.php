...
<?php include "header.php"; ?>	
	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-left">
				<img src="images/vintage_collection.png" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>The Daisy  <br> Collection</strong></h1>
...
<br> 
			...
			<li class="text-left">
				<img src="images/mini_collection.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
...
Gujarati Restaurants in Bopal, 
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="images/powdery_matte_tints.jpg"  width="200%" height="200%" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
