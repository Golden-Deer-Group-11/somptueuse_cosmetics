...
<div class="content">
	...
	<tr align="center">
			<td class="title">Upload New Product</td><td><a href="view_product.php" style="color: red; text-decoration: none;">View All Products</a></td>
    </tr>
   ...
   <tr align="center">   
    ...
    <tr>    
    	<td colspan=2 align="center"> <input type="submit" name="s" value="Upload now" class=
    		"btn"> </td>
    </tr>
...
if(isset($_POST['s']))
{
		...
		include "connect.php";
		mysqli_query($con,"insert into products (category,sub_cat,title,description,price,image) values('$cat','$scat','$title','$det','$price','$i')");
