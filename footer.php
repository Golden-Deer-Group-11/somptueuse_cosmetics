	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p><img src="images/logo_circle.png" width="100" height="100"></p>
					<p>© somptueuse cosmetics est. 2020</p>
				</div>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2020 <a href="#">Somptueuse Cosmetics</a> Developed By :  Golden Deer
					<a href=""></a><br>
				</p>
					</div>
				</div>
